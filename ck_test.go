...
func TestNewRecipe(t *testing.T) {
	...
	file, err = ioutil.ReadFile("testhtml/sahne.html")
	if err != nil {
		t.Error(err)
	}
	doc, err = goquery.NewDocumentFromReader(bytes.NewReader(file))
